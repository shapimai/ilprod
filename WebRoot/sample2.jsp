			...
			<div class="container">
				<div class="logo-nav">
					<div class="logo-nav-left">
						<h1>
							<a href="#">ILDoll <span>Dream4All</span>
							</a>
						</h1>
					</div>
						...
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									<li class="active"><a href="#"" class="act">Home</a>
									</li>
									<!-- Mega Menu -->
									<li class="dropdown"><a href="#" class="dropdown-toggle"
										...
										<ul class="dropdown-menu multi-column columns-3">
											<div class="row">
												...
												<div class="col-sm-3  multi-gd-img">
													<a href="#"><img src="images/woo.jpg" alt=" " />
													</a>
												</div>
												<div class="col-sm-3  multi-gd-img">
													<a href="#"><img src="images/woo1.jpg"
														alt=" " />
													</a>
												</div>
												<div class="clearfix"></div>
									...
									<li class="dropdown"><a href="#" class="dropdown-toggle"
										...
										<ul class="dropdown-menu multi-column columns-3">
											<div class="row">
												...
												<div class="col-sm-3  multi-gd-img">
													<a href="#"><img src="images/woo3.jpg"
														alt=" " />
													</a>
												</div>
												<div class="col-sm-3  multi-gd-img">
													<a href="#"><img src="images/woo4.jpg"
														alt=" " />
													</a>
												</div>
												<div class="clearfix"></div>
	...
	<div class="content">
		<div class="container">
			<div class=""
				...
				<div style="margin:1em"><p>website undergoing..</p><br><p>this is a sample page</p></div>
<%-- 
				<% 
